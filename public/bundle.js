...
/* harmony import */ var _models_film_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/film.js */ "./src/models/film.js");
...
class Provider {
    ...
    if (isOnline()) {
      return this._api.getFilms()
        .then((films) => {
          ...
          return _models_film_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilms(films);
        });
    }

    const storeFilms = Object.values(this._store.getItems());

    return Promise.resolve(_models_film_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseTasks(storeFilms));
  }
  ...
  updateFilm(id, film) {
    if (isOnline()) {
      return this._api.updateFilm(id, film)
        .then((newFilm) => {
          ...
          return _models_film_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilm(newFilm);
        });
    }
    ...
    return Promise.resolve(_models_film_js__WEBPACK_IMPORTED_MODULE_0__["default"].parseFilm(localFilm));
  }
...
class Comments extends _abstract_component_js__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  getInput() {
    ...
    const text = Object(he__WEBPACK_IMPORTED_MODULE_2__["encode"])(textAreaElement.value);
...
const createFilmCardTemplate = (film) => {
  ...
  const commentsCount = comments.length;
  const releaseYear = moment__WEBPACK_IMPORTED_MODULE_2___default()(release).format(`YYYY`);
...
const createFilmPopupTemplate = (film) => {
  ...
  const details = {
    ...
    'Actors': actors.join(`, `),
    'Release Date': moment__WEBPACK_IMPORTED_MODULE_2___default()(release).format(`D MMMM YYYY`),
...
/*!******************************************!*\
  !*** ./src/components/profile-button.js ***!
  \******************************************/
/*! exports provided: getRank, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _profile_button_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./profile-button.js */ "./src/components/profile-button.js");
...
const createTotalDurationMarkup = (films) => {
  ...
  const hours = totalDuration >= 60 ? `${moment__WEBPACK_IMPORTED_MODULE_4___default.a.duration(totalDuration, `minutes`).hours()} <span class="statistic__item-description">h</span>` : ``;

  const minutes = totalDuration > 0 ? `${moment__WEBPACK_IMPORTED_MODULE_4___default.a.duration(totalDuration, `minutes`).minutes()} <span class="statistic__item-description">m</span>` : ``;

  return hours && minutes ? `${hours} ${minutes}` : null;
};

const createStatisticsTemplate = (films, activeFilter) => {
  const userRank = Object(_profile_button_js__WEBPACK_IMPORTED_MODULE_1__["getRank"])(films);
...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: FILTERS, FilterType, FILMS, DESCRIPTIONS, GENRES, AGES, DIRECTORS, WRITERS, ACTORS, COUNTRIES, EMOTIONS, COMMENT_AUTHORS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _components_comments_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/comments.js */ "./src/components/comments.js");
...
class CommentsController {
  ...
  render() {
    ...
    this._commentsComponent = new _components_comments_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._comments);

    this._commentsComponent.setDeleteHandler(this._commentDeleteHandler);
    document.addEventListener(`keydown`, this._keydownHandler);

    if (oldCommentsComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._commentsComponent, oldCommentsComponent);

      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._commentsComponent);
  }
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._commentsComponent);
...
class Filter {
  ...
  render() {
    ...
    const filters = Object.values(_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"]).map((filterType, i) => {
      return {
        link: filterType,
        name: _const_js__WEBPACK_IMPORTED_MODULE_1__["FILTERS"][i],
        count: Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["getFilmsByFilter"])(allFilms, filterType).length,
    ...
    if (oldComponent) {
      ...
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(container, this._filterComponent, `afterbegin`);
    }
  }
...
/* harmony import */ var _components_film_popup_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/film-popup.js */ "./src/components/film-popup.js");
/* harmony import */ var _controllers_comments_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../controllers/comments.js */ "./src/controllers/comments.js");
/* harmony import */ var _models_film_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/film.js */ "./src/models/film.js");
...
class MovieController {
  ...
  render(film) {
    ...
    this._filmCardComponent = new _components_film_card_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._film);
    ...
    if (oldFilmCardComponent) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["replace"])(this._filmCardComponent, oldFilmCardComponent);

      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(this._container, this._filmCardComponent);
  }
  ...
  _changeData(field) {
    ...
    const newData = _models_film_js__WEBPACK_IMPORTED_MODULE_3__["default"].clone(this._film);
  ...
  _openPopupHandler() {
    this._filmPopupComponent = new _components_film_popup_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._film);
    this._filmPopupComponent.setControlsChangeHandler(this._changeData);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["render"])(document.body, this._filmPopupComponent);
  ...
  _renderComments() {
    ...
    .then((res) => {
      ...
      this._commentsController = new _controllers_comments_js__WEBPACK_IMPORTED_MODULE_2__["default"](this._filmPopupComponent.getElement().querySelector(`form`), this._film.comments, this._commentDeleteHandler, this._commentAddHandler);
  ...
  _closePopupHandler() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._filmPopupComponent);
  ...
  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_4__["remove"])(this._filmCardComponent);
  }
}
...
/* harmony import */ var _components_main_list_films_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/main-list-films.js */ "./src/components/main-list-films.js");
/* harmony import */ var _components_top_rate_films_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/top-rate-films.js */ "./src/components/top-rate-films.js");
/* harmony import */ var _components_most_commented_films_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/most-commented-films.js */ "./src/components/most-commented-films.js");
...
/* harmony import */ var _movie_controller_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./movie-controller.js */ "./src/controllers/movie-controller.js");
...
const renderFilms = (container, films, dataChangeHandler, api) => {
  return films.map((film) => {
    const filmController = new _movie_controller_js__WEBPACK_IMPORTED_MODULE_6__["default"](container, dataChangeHandler, api);
...
class PageController {
  constructor(container, filmsModel, api) {
    ...
    this._currentSortType = _components_sort_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].DEFAULT;

    this._sortComponent = new _components_sort_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._mainListFilmsComponent = new _components_main_list_films_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._topRateFilmsComponent = new _components_top_rate_films_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._mostCommentedFilmsComponent = new _components_most_commented_films_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
  ...
  render() {
    ...
    if (!this._filmsModel.getAllFilms().length) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, new _components_main_list_films_js__WEBPACK_IMPORTED_MODULE_1__["default"](false));

      return;
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._sortComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(container, this._mainListFilmsComponent);
  ...
  _renderShowMoreButton() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._mainListFilmsComponent.getElement().querySelector(`.films-list__container`), this._showMoreButtonComponent, `afterend`);
  ...
  _renderExtraFilmList() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._container.getElement(), this._topRateFilmsComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_5__["render"])(this._container.getElement(), this._mostCommentedFilmsComponent);
...
/* harmony import */ var _models_films_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./models/films.js */ "./src/models/films.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _api_index_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./api/index.js */ "./src/api/index.js");
/* harmony import */ var _api_provider_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./api/provider.js */ "./src/api/provider.js");
...
const api = new _api_index_js__WEBPACK_IMPORTED_MODULE_8__["default"](AUTHORIZATION, END_POINT);
const store = new _api_store_js__WEBPACK_IMPORTED_MODULE_10__["default"](STORE_NAME, window.localStorage);
const apiWithProvider = new _api_provider_js__WEBPACK_IMPORTED_MODULE_9__["default"](api, store);

const filmsModel = new _models_films_js__WEBPACK_IMPORTED_MODULE_6__["default"]();

const siteNavigationComponent = new _components_site_navigation_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
const filterController = new _controllers_filter_js__WEBPACK_IMPORTED_MODULE_5__["default"](siteNavigationComponent.getElement(), filmsModel);
const boardComponent = new _components_content_board_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
const pageController = new _controllers_page_controller_js__WEBPACK_IMPORTED_MODULE_4__["default"](boardComponent, filmsModel, apiWithProvider);
const statisticsComponent = new _components_statistics_js__WEBPACK_IMPORTED_MODULE_2__["default"](filmsModel);

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(siteHeaderElement, new _components_profile_button_js__WEBPACK_IMPORTED_MODULE_0__["default"](filmsModel));
filterController.render();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(siteMainElement, siteNavigationComponent);
...
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_7__["render"])(siteMainElement, statisticsComponent);
...
class Films {
  ...
  getWatchedFilms() {
    return Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_0__["getFilmsByFilter"])(this._films, _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].WATCHED);
  }

  getFilms() {
    return Object(_utils_filter_js__WEBPACK_IMPORTED_MODULE_0__["getFilmsByFilter"])(this._films, this._activeFilter);
  }
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomCountOfElementsFromArray, formatDuration, getRandomNumber, getRandomElementFromArray, getRandomDate, formatDate, createElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const formatDuration = (duration) => {
  const hours = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration, `minutes`).hours();
  const minutes = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(duration, `minutes`).minutes();
...
// once
const getRandomDate = (isSettingBigYearRange = false) => {
...
const formatDate = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`YYYY/M/D HH:mm`);
};
...
/*!*****************************!*\
  !*** ./src/utils/filter.js ***!
  \*****************************/
/*! exports provided: getWatchlistFilms, getWatchedFilms, getFavoriteFilms, getFilmsByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getWatchlistFilms", function() { return getWatchlistFilms; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getWatchedFilms", function() { return getWatchedFilms; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFavoriteFilms", function() { return getFavoriteFilms; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFilmsByFilter", function() { return getFilmsByFilter; });
...
const getFilmsByFilter = (films, filterType) => {
  ...
  switch (filterType) {
    ...
    case _const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHLIST:
      filteredFilms = getWatchlistFilms(films);
      break;

    case _const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHED:
      filteredFilms = getWatchedFilms(films);
      break;

    case _const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITES:
